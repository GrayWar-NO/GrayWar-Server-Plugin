...
/// 
[AutoCommand]
public class GambleCommand(ConfigFile config) : PermissionConfigurableCommand(config), IGameCommand 
{
    /// <inheritdoc />
    public override string Name => "gamble";
    
    /// <inheritdoc />
    public override string Description => "50% chance you receive 2x your bet. IF you lose, 20% chance you eject out of rage";
    
    /// <inheritdoc />
    public override string Usage => $"gamble <$ in million>. eg: '{PluginConfig.CommandPrefixChar}gamble 100' gambles 100m";
